...
#ifndef DYNAMIC_STEINER_HSVSOLVER_H
#define DYNAMIC_STEINER_HSVSOLVER_H
...
namespace steiner {
    class DynamicHsvSolver {
    public:
        DynamicHsvSolver(SteinerInstance *instance, node_id dualAscentLimit);
    ...
    private:
        ...
        DynamicSteinerHeuristic* heuristic_;
...
#endif //DYNAMIC_STEINER_HSVSOLVER_H
